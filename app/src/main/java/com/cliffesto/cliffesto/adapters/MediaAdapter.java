...
public class MediaAdapter extends RecyclerView.Adapter<MediaAdapter.MyViewHolder> {
    ...
    public MediaAdapter(List<SponsersBean> gList, Context c) {
    ...
    public void onBindViewHolder(MediaAdapter.MyViewHolder holder, final int position) {
        ...
        holder.call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("cliffesto").child("medialink").child("" + position).child("link").addValueEventListener(new ValueEventListener() {
                    @Override
